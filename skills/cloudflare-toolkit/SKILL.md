...
[Testing guide](https://adrianhall.github.io/cloudflare-toolkit/guides/testing#vite-vitest-configuration-for-a-hono-workers-project)'s
"Vite + Vitest configuration for a Hono/Workers project" section: one copy of this worked example
for a coding agent reading this file, one for a human reading the docs site. If you change the
pattern below, update both (see `AGENTS.md`'s architectural rules).
