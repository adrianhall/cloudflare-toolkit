...
description: Terraform v5 best practices for the Cloudflare provider. Use when writing, reviewing, or generating Terraform/HCL that provisions the Cloudflare Developer Platform (Workers, D1, Workers KV, R2, Queues, Zero Trust Access).
---
